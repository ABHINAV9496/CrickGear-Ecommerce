...
const Orders = () => {
  ...
  // ── Fetch this user's orders from Django ────────────────────
  // GET /api/orders/my/ returns only orders belonging to the logged-in user
  useEffect(() => {
  ...
  // ── Cancel order — Django restores stock automatically ──────
      ...
      <div>
        ...
        <div className="flex gap-3">
          <button
            onClick={async () => {
              try {
                // POST /api/orders/5/cancel/ — Django sets status=Cancelled + restores stock
            ...
            <div key={order.id} className="bg-[#0a0a0a] border border-gray-800 rounded-lg p-6 hover:border-gray-700 transition-colors">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 pb-4 border-b border-gray-800/60">
                <div>
                  ...
                  {/* Django returns created_at as ISO string — format it nicely */}
                ...
                <div className="flex items-center gap-4 sm:flex-col sm:items-end sm:gap-1">
                  ...
                  <p className={`text-xs font-semibold px-3 py-1 rounded uppercase tracking-wider ${
              ...
              {/* Shipping Address + Cancel Button */}
